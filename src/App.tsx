  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              <div className="flex-shrink-0 flex items-center">
                ...
                <span className="ml-2 text-2xl font-bold text-gray-900">KaaryaBharat</span>
              </div>
            </div>
      ...
      <section className="py-20 bg-blue-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">Why Choose KaaryaBharat?</h2>
      ...
      <footer className="bg-gray-900 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="space-y-4">
              <div className="flex items-center">
                ...
                <span className="ml-2 text-2xl font-bold">KaaryaBharat</span>
              </div>
          ...
          <div className="border-t border-gray-800 pt-8 mt-12 text-center text-gray-400">
            <p>&copy; 2025 KaaryaBharat. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
